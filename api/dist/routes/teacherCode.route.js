...
var app = express();
var teacherCodeRoutes = express.Router();
var TeacherCode = require('../models/teacherCode');
teacherCodeRoutes.route('/create').post(function (req, res) {
    var teacherCode = new TeacherCode(req.body);
    teacherCode.save().then(function (teacherCode) {
