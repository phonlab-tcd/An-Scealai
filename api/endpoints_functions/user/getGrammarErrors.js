...
let test = [
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        sentence:
          "Bhain mé taitneamh as ár bplé an tseachtain seo, tá teicneolaíocht na hurlabha nua seo ar fad corraitheach.",
      },
      {
        errors: [
          {
          ...
          },
          {
            ...
            messages: {
              en:
                "Possibly a foreign word (the sequence /Duo/ is highly improbable)",
              ga:
                "B'fhéidir gur focal iasachta é seo (tá na litreacha ‘Duo’ neamhchoitianta)",
            },
          },
        ],
        sentence:
          "Mar a deir cúpla daoine eile, ceapaim go bhfuil Duolingo an teicneolaíocht teanga is mó tóir.",
      },
      {
        errors: [],
        sentence:
          "Tá a fhios agam go mbaineann go leor de mo chairde úsáid as.",
      },
      {
        errors: [],
      ...
      },
      {
        errors: [],
        sentence:
          "D'úsáid mé é chun Iodáilis a fhoghlaim, nuair a bhí mé san idirbhliain.",
      },
      {
        errors: [
          {
          ...
          },
          {
            ...
            messages: {
              en:
                "Not in database but apparently formed from the root /chabhrach/",
              ga: "Focal anaithnid ach bunaithe ar ‘chabhrach’ is dócha",
            },
          },
        ],
        sentence:
          "Shíl mé go raibh an aip an-chabhrach, ach ar an drochuair níor choinnigh mé suas le mo chuid foghlama air.",
      },
      {
        errors: [],
      ...
      },
      {
        ...
        sentence:
          "Fuair a lán de mo chairde atá ag dul ar erasmus i mbliana gur acmhainn iontach é.",
      },
      {
        errors: [
          {
            ...
            messages: {
              ...
              ga:
                "Focal anaithnid ach b'fhéidir gur comhfhocal ‘bun+eilimintí’ é?",
            },
          },
        ],
        sentence:
          "Foghlaimíonn siad buneilimintí theanga na tíre a mbeidh siad ag staidéar ann, mar shampla Ollainnis, Spáinnis, nó Fraincis.",
      },
      {
        errors: [],
        sentence:
          "Maidir leis an gcóras aitheanta cainte, fuair mé amach gur phioc sé an méid a bhí á rá agam go gasta.",
      },
      {
        errors: [],
      ...
      },
      {
        errors: [],
        sentence:
          "Is fíor nach raibh mórán teicneolaíochtaí urlabhra agus teanga ar fáil do na mionteangacha ann roimhe seo, mar sin is feabhas mór é seo.",
      },
      {
        errors: [],
        sentence:
          "Is bealach iontach é freisin chun an Ghaeilge a dhéanamh níos inrochtana, do dhaoine bodhra nó dall.",
      },
      {
        errors: [],
        sentence:
          "Is dea-scéal é seo, mar ní raibh seirbhísí riamh ann mar théacs go hurlabhra don Ghaeilge san am atá thart.",
      },
      {
        errors: [],
  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        sentence:
          "Fuair a lán de mo chairde atá ag dul ar erasmus i mbliana gur acmhainn iontach é. Foghlaimíonn siad buneilimintí theanga na tíre a mbeidh siad ag staidéar ann, mar shampla Ollainnis, Spáinnis, nó Fraincis.",
      },
      {
        errors: [],
        sentence:
...
const studentEntries = require('./storygrammarerrors.json');
    ...
    if (entry.errors.length > 0) {
      for (const error of entry.errors) {
        const errorEntry = {
          ...
          date: new Date(+errorObject.timestamp.$date.$numberLong).toISOString().slice(0, 10)
        };
