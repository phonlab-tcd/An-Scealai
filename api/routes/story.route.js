 ...
 *                  id:
 *                    type: string
 *                    example: 41492094-7c40-4ca8-8289-ab3894b66b61
 *                  title: 
 *                    type: string
 *                    example: "An Spailpín Fánach"
 *                  date: 
 *                    type: Date
 *                    example: 2021-05-04T14:18:24.194Z
 *                  dialect:
 *                    type: string
 *                  text:
 *                    type: string
 *                    example: "Im spailpín fánach"
 *                  author:
 *                    type: string 
 *                    example: "neimhin"
 *                  lastUpdated:
 *                    type: Date
 *                    example: "2021-06-11T10:05:18.498Z"
 *                  activeRecording:
 *                    type: string
 *                    example: "60a415e1f4e66fe6f331134f"
 *                  __v:
 *                    type: integer
 *                    example: 0
 *        404:
 *          description: There was no story with the given id.
 */
storyRoutes.route('/getStoryById/:id').get((req, res) => {
  console.log("/story/getStoryById/",req.params.id,"has been called");
