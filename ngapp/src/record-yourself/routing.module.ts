...
const routes: Routes = [
  ...
  { path: 'recording/:id', component: RecordingComponent, canDeactivate: [CanDeactivateRecordingGuard] },
  { path: 'archive/:id', component: RecordingHistoryComponent},
  { path: 'view/:id', component: ViewRecordingComponent },
];
