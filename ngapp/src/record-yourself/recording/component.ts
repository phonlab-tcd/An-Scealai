...
export class RecordingComponent implements OnInit {
  ...
  sentence_paragraph_selection(value: 'sentence' | 'paragraph') {
    this[value + 'Mode']();
  }


  // Call getStory() to get current story recording,
  // story data, synthesise, and recordings
  // Reset variables when recording text updated
  // (function called in updateStory())
  ngOnInit() {
