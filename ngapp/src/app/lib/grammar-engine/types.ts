...
export const ERROR_TYPES = Object.keys(ERROR_INFO) as ErrorType[];

export const CHECKBOXES = {} as CHECKBOX_TYPE;
ERROR_TYPES.forEach(type=>{
  CHECKBOXES[type] = true;
});

export type CHECKBOX_TYPE = {[key in ErrorType]: boolean};
