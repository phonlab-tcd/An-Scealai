const translations = {
  ...
  username: {
    ...
    en: 'Username' },
  username_not_found: {
    ga: 'Níor thángthas ar an ainm seo',
  ...
  password: {
    ...
    en: 'Password' },
  reset_password: {
    ga: 'Pasfocal a athshocrú',
    en: 'Reset password' },
  incorrect_password: {
    ga: 'Pasfhocal mícheart.',
  ...
  genitive: {
    ...
    en: 'Genitive' },
  grammar_check: {
    ga: 'Seiceáil Gramadaí',
    en: 'Grammar Check' },
  show_grammar_suggestions: {
    ga: 'Taispeáin moltaí gramadaí',
    en: 'Show grammar suggestions' },
  ...
  listen_back_to_your_story: {
    ga: 'Éist le do scéal',
    en: 'Listen to your story' },
  correcting_grammar: {
    ga: 'An Ghramadach á Seiceáil',
    en: 'Correcting Grammar' },
  grammar_checker: {
    ga: 'Seiceálaí Gramadaí',
    en: 'Grammar Checker' },
  uncheck_all: {
    ga: 'Bain na ticeanna uilig',
    en: 'Uncheck all' },
  check_all: {
  ...
  gramadoir: {
    ...
    en: 'An Gramadóir' },
  broad_slender: {
    ga: 'Seiceáil ar Leathan/Caol',
    en: 'Broad/Slender Checker' },
  broad_slender_agreement: {
    ga: 'Leathan/caol',
    en: 'Broad/slender vowel agreement' },
  profile: {
    ga: 'Mo chuid sonraí',
    en: 'My Profile' },
  classroom_code: {
  ...
  current_username: {
    ga: 'Ainm úsáideora reatha',
    en: 'Current username' },
  new_username: {
    ga: 'Ainm úsáideora nua',
    en: 'New username' },
  enter_username: {
  ...
  verify_email_address: {
    ga: 'Seoladh ríomhphoist a fhíorú',
  ...
  third_level: {
    ...
    en: '3rd level' },
  gaeltacht_immersion_course: {
    ga: 'Cúrsa Gaeltachta',
    en: 'Gaeltacht immersion course' },
  ...
  comprehension_level_3: {
    ga: 'Cuid den comhrá',
    en: 'Parts of the conversation' },
  ...
  synth_opinion_1: {
    ga: 'Ní maith liom iad',
    en: "I don't like them" },
  synth_opinion_2: {
  ...
  read_irish: {
    ga: 'An léann tú as Gaeilge?',
    en: 'Do you read in Irish?' },
  write_irish: {
    ga: 'An scríobhann tú as Gaeilge?',
  ...
  poetry: {
    ...
    en: 'Poetry' },
  synthetic_voices: {
    ga: 'Guthanna sintéiseacha',
    en: 'Synthetic Voices' },
  language_competence: {
    ga: 'Cumas teanga',
    en: 'Language Competence' },
  exposure_to_irish: {
    ga: 'Cleachtadh ar an nGaeilge',
    en: 'Exposure to Irish' },
  which_dialect: {
  ...
  add_new_classroom: {
    ga: 'Cruthaigh seomra ranga nua',
    en: 'Add new Classroom' },
  enter_title: {
    ga: 'Cuir teideal isteach',
    en: 'Enter title' },
  classrooms: {
    ga: 'Seomraí ranga',
    en: 'Classrooms' },
  no_students: {
    ga: 'Líon na ndaltaí',
    en: 'No. Students' },
  edit_classroom_title: {
    ga: 'Leasaigh ainm an tseomra ranga',
    en: 'Edit classroom title' },
  edit_title_or_dialect: {
    ga: 'Athraigh teideal/canúint',
    en: 'Edit title/dialect' },
  done: {
    ga: 'Déanta',
  ...
  seen_by: {
    ...
    en: 'Seen by' },
  not_seen_by: {
    ga: 'Níl sé feicthe ag',
    en: 'Not seen by' },
  sent: {
    ga: 'Curtha ar aghaidh',
    en: 'Sent' },
  audio_message: {
    ga: 'Clos-scéal',
    en: 'Audio message' },
  ...
  school_name: {
    ga: 'Ainm na scoile',
    en: 'Name of the school where you teach' },
  ...
  my_classrooms: {
    ...
    en: 'My Classrooms' },
  teacher_account_code: {
    ga: 'Cód chuntas an mhúinteora',
    en: 'Teacher account code' },
  generate: {
    ga: 'Gin',
    en: 'Generate' },
  copied: {
  ...
  active_account_codes: {
    ga: 'Cód Cuntais Reatha',
    en: 'Active Account Codes' },
  search_user: {
    ga: 'Lorg Úsáideoir',
    en: 'Search User' },
  admin_dashboard: {
    ga: 'Deais an Riarthóra',
    en: 'Admin Dashboard' },
  teachers: {
    ga: 'Múinteoirí',
    en: 'Teachers' },
  ...
  compiling_data: {
    ga: 'Sonraí á gcur le chéile',
    en: 'Compiling data' },
  net_errors_corrected: {
    ga: 'Líon earráidí a ceartaíodhd',
    en: 'Net errors corrected' },
  author_admin: {
    ga: 'Údar',
    en: 'Author' },
  history_of_title: {
  ...
  history_of_story: {
    ...
    en: 'History of story' },
  teacher_accounts: {
    ga: 'Cuntais na Múinteoirí',
    en: 'Teacher Accounts' },
  profile_summary: {
    ga: 'Achoimre ar phróifíl do',
    en: 'Profile Summary for' },
  role: {
    ga: 'Ról',
    en: 'Role' },
  ISODate: {
    ...
    en: 'ISODate' },
  story_id: {
    ga: 'Comhartha aitheantais an scéil',
    en: 'Story id' },
  story_text: {
    ga: 'Téacs an scéil',
    en: 'Story text' },
  ...
  previous_data: {
    ...
    en: 'Previous Data' },
  enter_date_range: {
    ga: 'Cuir raon sonraíochta isteach',
    en: 'Enter a date range' },
  invalid_start_date: {
    ga: 'Dáta tosaithe neamhbhailí',
    en: 'Invalid start date' },
  invalid_end_date: {
    ga: 'Dáta deiridh neamhbhailí',
    en: 'Invalid end date' },
  ...
  get_data: {
    ...
    en: 'Get Data' },
  add_data_log: {
    ga: 'Cuir log sonraíochta leis seo',
    en: 'Add Data Log' },
  profile_stats: {
    ga: 'Staitisticí faoi na próifílí',
    en: 'Profile Stats' },
  feature_stats: {
    ga: 'Gné-staitisticí',
    en: 'Feature Stats' },
  profiles_found: {
    ga: 'Próifílí a fuarthas',
    en: 'Profiles Found' },
  gender_of_users: {
    ga: 'Gender of users',
    en: 'Gender of users' },
  age_of_users: {
    ga: 'Aois na n-úsáideoirí',
    en: 'Age of users' },
  countries_of_users: {
    ga: 'Tíortha na n-úsáideoirí',
    en: 'Countries of users' },
  ...
  student_school_level: {
    ga: 'Leibhéal Scoile na Macléann',
    en: 'Student School Level' },
  ...
  third_level_studies: {
    ga: 'Micléinn tríú leibhéal',
    en: 'Third Level Studies' },
  ...
  teacher_primary_school: {
    ga: 'Múinteoirí bunscoile',
    en: 'Teacher Primary School' },
  ...
  native_tongue_father: {
    ga: 'Teanga dhúchais an athar',
    en: 'Native tongue of father' },
  native_tongue_mother: {
    ga: 'Teanga dhúchais na máthar',
    en: 'Native tongue of mother' },
  years_of_irish: {
    ga: 'Blianta le Gaeilge',
    en: 'Years of Irish' },
  ...
  speaking_frequency: {
    ga: 'Minicíocht a labhartha',
    en: 'Speaking Frequency' },
  ...
  synth_opinion: {
    ga: 'Meas ar chaint shintéiseach',
    en: 'Synth Opinion' },
  ...
  messages: {
    ...
    en: 'Messages' },
  new_message: {
    ga: 'Teachtaireacht Nua',
    en: 'New Message' },
  new_messages: {
    ga: 'Teachtaireachtaí Nua',
    en: 'New Messages' },
  send_to: {
    ga: 'Curtha go',
    en: 'Send to' },
  ...
  subject: {
    ...
    en: 'Subject' },
  date: {
    ga: 'Dáta na dteachtaireachtaí',
    en: 'Date' },
  no_messages: {
    ga: 'Níl teachtaireachtaí agat',
    en: 'You have no messages' },
  add_to_message: {
    ga: 'Cuir leis an teachtaireacht',
    en: 'Add to message' },
  all_class_members: {
    ga: 'Gach ball den Rang',
    en: 'All class members' },
  stats: {
    ga: 'Staitisticí',
    en: 'Stats' },
  statistics: {
  ...
  classroom_statistics: {
    ga: 'Staitisticí Ranga',
    en: 'Classroom Statistics' },
  grammar_errors: {
    ga: 'Earráidí Gramadaí',
    en: 'Grammar Errors' },
  edit_grammar_errors: {
    ga: 'Déan eagarthóireacht ar na hearráidí gramadaí',
    en: 'Edit Grammar Errors' },
  total_grammar_errors: {
    ga: 'Iomlán na nEarráidí Gramadaí',
    en: 'Total Grammar Errors' },
  select_all: {
    ga: 'Roghnaigh Gach Rud',
    en: 'select all' },
  dictionary: {
    ga: 'Foclóir',
    en: 'Dictionary' },
  ...
  user_guide: {
    ga: "Treoir d'Úsáideoirí",
    en: 'User Guide' },
  academic_paper: {
    ga: 'Foilseachán Acadúil',
    en: 'Academic Paper' },
  what_is_an_scealai: {
    ga: 'Cad é An Scéalaí?',
  ...
  meet_the_artist: {
    ga: 'Seo agaibh an tEalaíontóir…',
    en: 'Meet the Artist… ' },
  meet_the_abair_team: {
    ga: '…Agus Foireann ABAIR.ie',
    en: 'Meet the ABAIR.ie team…' },
  maddie_bio: {
    ga: 'As Stáit Aontaithe Mheirceá ó dhúchas, bhog Madeleine go Baile Átha Cliath chun freastal ar Choláiste na Tríonóide agus céim a dhéanamh san Eolaíocht Ríomhaireachta agus Teanga (2021) agus ansin chun Máistreacht a dhéanamh sa Ríomheolaíocht (2022). Is forbróir gréasáin í le <i>An Scéalaí</i> a chuireann le dearadh agus le feidhmiú taobh tosaigh agus cúltaobh an ardáin, chomh maith le hanailís a dhéanamh ar shonraí a bailíodh ó húsáideoirí. Tá an-suim ag Madeleine i bhforbairtí FRT-chliste agus tá súil aici leanúint de bheith ag obair sa réimse seo amach anseo.',
    en: 'Originally from the United States, Madeleine moved to Ireland to study at Trinity College Dublin, where she received a bachelor\'s degree in Computer Science, Linguistics and a Language (2021), and a Masters degree in Computer Science (2022).  She is a Research Assistant and Full Stack Web Developer for the <i>An Scéalaí</i> platform, involved with the design, implementation, testing, and data analysis aspects of the project.  Madeleine has an interest in iCALL development and hopes to continue contributing to this field.' },
  oisin_bio: {
  ...
  sarah_bio: {
    ga: 'Is as Baile Átha Cliath í Sarah, agus fuair sí a céim le déanaí sna Teangacha agus Cultúir an Mheán-Oirthir agus na hEorpa, le béim ar an nGearmáinis agus ar an Araibis. D\'fhreastal sí ar scoileanna lán-Ghaeilge agus í ag fás aníos, agus bhí Fraincis aici sa bhaile. Tá an-suim aici i dteangacha, agus tá sí ag úsáid na suime sin chun cabhrú leis an tionscadal ABAIR.ie',
    en: 'Sarah is from Dublin, and she recently graduated with her degree in Middle Eastern and European Languages and Cultures, with a focus on German and Arabic. She attended Irish medium schools growing up, and French was spoken at home. She has a keen interest in languages, and is using that interest to help out on the ABAIR.ie project. ' },
  abair_bio: {
  ...
  higher_level: {
    ...
    en: 'Higher Level' },
  gweedore: {
    ga: 'Guth Ghaoth Dobhair',
    en: 'Voice of Gweedore' },
  mumhan: {
    ga: 'Guth na Mumhan',
    en: 'Voice of Mumhan' },
  ...
  LARA_for_Irish_title: {
    ga: 'LARA don Ghaeilge',
    en: 'LARA for Irish' },
  LARA_for_Irish: {
  ...
  for_teachers_point1: {
    ga: 'díospóireacht ranga a thosú',
    en: 'promote class discussion' },
  for_teachers_point2: {
  ...
  for_teachers_point3: {
    ga: 'pointí gramadaí a léiriú',
    en: 'reinforce grammar points' },
  for_teachers_point4: {
  ...
  LARA_texts_include: {
    ga: 'I measc théacsanna LARA tá:',
    en: 'LARA texts include:' },
  ...
  more_information: {
    ga: 'Tuilleadh Eolais',
    en: 'More Information' },
  on_the_background_of_LARA: {
    ga: '…ar chúlra LARA:',
    en: '…on the background of LARA:' },
  background_point1: {
  ...
  on_the_research_background: {
    ga: '…ar an gcúlra taighde:',
    en: '…on the research background:' },
  ...
  on_the_research_background_point3: {
    ga: 'tuilleadh le teacht…',
    en: 'more to come...' },
  ...
  sample_research_papers: {
    ga: '…Páipéirí Taighde - Samplaí',
    en: '…Sample Research Papers' },
  lara_paper1: {
  ...
  the_abair_initiative: {
    ga: 'ABAIR:',
    en: 'The ABAIR Initiative:' },
  abair_paper1: {
  ...
  other_relavent_research: {
    ga: 'Taighde ábhartha eile:',
    en: 'Other relevant research:' },
  ...
  taidhgin_title: {
    ga: 'Taidhgín: Déan Comhrá',
    en: 'Taidhgín Bot' },
  create_quiz_title: {
    ga: 'Cruthaigh do quiz féin',
    en: 'Create your own quiz' },
  what_is_taidhgin_title: {
    ga: 'Cad é Taidhgín?',
    en: 'What is Taidhgín?' },
  about_taidhgin1: {
  ...
  quiz_a_title: {
    ...
    en: 'Answers' },
  my_quiz_s: {
    ga: 'Na Quizeanna Agamsa',
    en: 'My Quizzes' },
  taidhgin_about: {
    ga: 'Eolas',
    en: 'About' },
  taidhgin_choose_dialect: {
    ga: 'Pioc do rogha canúna',
    en: 'Choose Dialect' },
  taidhgin_audio_autoplay: {
    ga: 'Uathsheinn',
    en: 'Audio Autoplay' },
  taidhgin_choose_topic: {
    ga: 'Roghnaigh Topaic',
    en: 'Choose a Topic' },
  t_community_quiz: {
    ga: 'Quizeanna ón bPobal',
    en: 'Community Quizzes' },
  t_insert_q: {
    ga: 'Scríobh ceist anseo',
    en: 'Write question here' },
  t_insert_a: {
    ga: 'Scríobh freagra anseo',
    en: 'Write answer here' },
  t_enterName: {
    ga: 'Ainm an Quiz',
    en: 'Name Quiz' },
  taidhgin_currentDialect: {
    ga: 'Canúint: Corca Dhuibhne',
    en: 'Dialect: Kerry' },
  taidhgin_my_quiz_title: {
    ga: 'Na Quizeanna Agamsa',
    en: 'My Quizzes' },
  taidhgin_signup: {
  ...
  my_teachquiz: {
    ga: 'Quizeanna mo Mhúinteora',
    en: "My Teacher's Quizzes" },
  ...
  t_downloadQuiz: {
    ga: 'Íoslódáil an quiz?',
    en: 'Download copy of your quiz?' },
  fillAllEntries: {
    ga: 'Líon isteach gach bosca',
    en: 'Fill in all entries' },
  publish_script_y: {
    ga: 'Ba mhaith',
    en: 'Yes' },
  publish_script_n: {
  ...
  dnn_synthesiser: {
    ga: 'modh DNN',
    en: 'DNN synthesiser' },
  go_to_fast_synthesiser: {
    ga: 'Bain triail as modh HTS',
    en: 'Try the HTS synthesiser' },
  script_exists: {
    ga: 'Tá an teideal seo in úsáid cheana',
    en: 'Quiz with this name already exists' },
  taidhgin_verified_message: {
    ga: 'Faofar d’iontráil',
    en: 'Your quiz will be verified.' },
  forgetQuizName: {
    ga: 'Gaeilge Version',
  ...
  fios_title: {
    ga: 'FioS: Foghlaim le hIntleacht Shaorga – Fiosracht a Spreagadh',
    en: 'Trinity College Dublin – FIoS: Foghlaim le hIntleacht Shaorga' },
  fios_intro: {
    ga: 'Táimid thar a bheith sásta FioS a fhógairt i gColáiste na Tríonóide. Is é seo ár meitheal taighde ceannródaíoch atá dírithe ar Intleacht Shaorga a iniúchadh agus a chomhcheangal le teagasc agus le foghlaim na Gaeilge. ',
  ...
  fios_welcome: {
    ga: 'Fáilte go FioS: Meitheal Taighde ar FRT-chliste don Ghaeilge',
    en: 'Welcome to FIoS: iCALL for Irish Research Group' },
  our_mission: {
    ga: 'Ár Misean',
    en: 'Our mission' },
  fios_mission: {
    ga: 'Tagraíonn \'FioS\' d’eolas agus is é tóraíocht an eolais ár mbun aidhm: an chumhacht atá ag Intleacht Shaorga a ionramháil agus a chur in oiriúint d’fhoghlaimeoirí agus do lucht labhartha na Gaeilge go ginearálta. Tá labhairt na teanga ar an gcloch is mó ar ár bpaidrín agus creidimid go mba cheart go mbeadh fáil ag gach teanga, go háirithe iad siúd atá faoi bhagairt, ar an teicneolaíocht nua-aimseartha. Is gá a bheith cruthaitheach agus an nua-theicneolaíocht á cur in oiriúint do na teangacha neamh-fhorleathana ionas go bhfanfaidh siad beo beathach agus ábalta páirt a ghlacach  sa ré dhigiteach.',
  ...
  what_we_do: {
    ...
    en: 'What we do' },
  what_we_do_1: {
    ga: 'Tá FioS dírithe go príomha ar theicneolaíochtaí na teanga agus na hurlabhra a fhorbairt agus a chur in oiriúint d’fhoghlaimeoirí na Gaeilge. Ní mór a bheith an-cháiréiseach le forbairt na n-uirlisí seo agus an fhorbairt a dhéanamh i gcomhpháirt le múinteoirí agus le pobal na Gaeilge i gcoiteann ionas go mbeidh siad oiriúnach don teagasc agus do shaol na Gaeilge. Tá sé mar aidhm againn go mbeidh an teicneolaíocht chliste éifeachtach mar mheán teagaisc agus go léireoidh sí saibhreas na Gaeilge do gach foghlaimeoir.',
  ...
  what_we_do_2: {
    ga: 'Is forbairt nádúrtha é FioS ar an obair cheannródaíoch a rinneadh mar chuid de thionscadal ABAIR. Tá obair mhór á déanamh mar chuid de thionscadal ABAIR i bhforbairt na mbunteicneolaíochtaí, téacs go hurlabhra agus aithint cainte. Toisc go bhfuilimid nasctha go dlúth le ABAIR tá teacht againn ar theicneolaíochtaí ilchanúnacha, rud a chuireann lenár ndúthracht chun an Ghaeilge a chur ar fáil go héasca don uile dhuine.',
  ...
  what_we_do_3: {
    ga: 'Tá an aidhm atá againn níos leithne ná an teicneolaíocht. Táimid ag iarraidh an teanga bheo a chur os comhair gach foghlaimeora.  Samhlaímid comhthéacs foghlama ina mbeadh fáil ag gach foghlaimeoir ar mhúinteoir den scoth atá deartha le díogras ag muintir FioS.',
  ...
  key_CALL_for_irish_initiatives: {
    ga: 'FRT-chliste don Ghaeilge',
    en: 'Key CALL for Irish Initiatives' },
  an_scealai_interactive_learning_platform: {
    ga: 'An Scéalaí - Ardán Foghlama Idirghníomhach',
    en: 'An Scéalaí Interactive Learning Platform' },
  key_CALL_1: {
    ga: 'táimid ag tógáil ardáin FRT-chliste don Ghaeilge atá dearaithe chun cleachtadh foghlama bunaithe ar a shainriachtanais féin a thabhairt do gach foghlaimeoir agus freagairt dá luas foghlama, dá bhuanna agus dá riachtanais.',
  ...
  key_CALL_2: {
    ga: 'dírithe ar na briathra neamhrialta é seo lenar féidir le foghlaimeoirí idirghníomhú le teagascóir ríomhbhunaithe agus cleachtadh a dhéanamh ar 11 bhriathar neamhrialta sna haimsirí agus sna foirmeacha éagsúla.',
  ...
  key_CALL_3: {
    ga: 'gineann sé seo spreagadh d’fhonn tús a chur le scéal.',
  ...
  key_CALL_6: {
    ga: 'céile comhraic atá in ann comhrá bunúsach a choimeád i réimsí éagsúla cainte - an teaghlach, cúrsaí baile, laethanta saoire agus a leithéid eile',
  ...
  key_CALL_7: {
    ga: 'corpas foghlaimeoirí atá á thiomsiú ó shonraíocht a thagann ó ardán FRT-chliste - An Scéalaí',
    en: 'a learner corpus being gathered from the An Scéalaí iCALL platform' },
  core_technologies_employed_for_CALL: {
    ga: 'Na Bunteicneolaíochtaí atá in úsáid in FRTchliste don Ghaeilge – tionscadal ABAIR ',
    en: 'Core Technologies employed for Irish iCALL - the ABAIR initiative' },
  text_to_speech_synthesis: {
    ga: 'Téacs go húrlabhra - Caint Shintéiseach',
    en: 'Core Technologies employed for Irish iCALL - the ABAIR initiative' },
  core_technologies_1: {
    ga: 'Aistríonn an córas seo an focal scríofa isteach ina chaint nádúrtha intuigthe. Tá an comhcheangal  idir guthanna sintéiseacha ABAIR, a chuireann múnlaí de chaint dhúchasach sna trí mhórchanúint ar fáil, thar a bheith tábhachtach chun an ceangal idir an focal scríofa agus an focal labhartha a dhaingniú d’fhoghlaimeoirí. Trí thum-thimplleacht a chruthú ina bhfuil an léitheoireacht agus an scríbhneoireacht comhtháite go dlúth leis an gcaint beidh teacht ag foghlaimeoirí ar Ghaeilge nádúrtha na Gaeltachta mar mhúnla dá gcaint féin.',
  ...
  speech_recognition_for_irish: {
    ga: 'Aithint Cainte don Ghaeilge',
    en: 'Speech Recognition for Irish' },
  core_technologies_2: {
    ga: 'is féidir lenár gcóras an chaint a aistriú go dtí an focal scríofa agus trascríobh a thabhairt don bhfoghlaimeoir ar an bpointe. Nuair atá aithint cainte leabaithe mar dhlúthchuid den ardán tugtar an deis chun tús áite a thabhairt don gcaint. Is athrú mór é seo ar mhodhanna teagaisc a leag béim ar an téacs scríofa agus tugann sé deis modhanna nua teagaisc a chleachtadh, modhanna nach raibh ar fáil roimhe seo. ',
  ...
  nlp_for_irish: {
    ga: 'Próiseáil Teanga Nádúrtha don Ghaeilge',
    en: 'Natural Language Processing (NLP) for Irish' },
  core_technologies_3: {
    ga: 'Tá sé de bhuntáiste againn sa Scéalaí gur féidir linn An Gramadóir, bunsaothar Kevin Scannell a dhéanann seiceáil ar ghramadach, a úsáid. Faoi láthair táimid ag forbairt modúl dár gcuid féin chomh maith chun an litriú agus gnéithe den ghramadach a cheartú agus aiseolas cuí a thabhairt don bhfoghlaimeoir de réir a leibhéil agus a riachtanas féin.',
  ...
  collaboration_and_outreach: {
    ga: 'Caidreamh agus Comhoibriú',
    en: 'Collaboration & Outreach' },
  collaboration_and_outreach_text: {
    ga: 'Ba bhreá linn comhoibriú le hoideachasóirí, teicneolaithe, teangeolaithe agus leo siúd gur spéis leo an Ghaeilge. Is é an cuspóir atá againn ná pobal a chruthú ina mbeidh comhnascadh de shaineolas agus díogras i leith na Gaeilge',
  ...
  join_us: {
    ...
    en: 'Join us' },
  join_us_text: {
    ga: 'Ba mhaith linn cuireadh a thabhairt duit teacht ar an ród linn más macléinn tú gur spéis leat ár dtaighde, nó múinteoir atá ag iarraidh ár gcóras a úsáid mar chuid de do chleachtas múinteoireachta, nó duine a bhfuil paisean ar leith acu don Ghaeilge.',
  ...
  updates_and_news: {
    ...
    en: 'Updates & News' },
  updates_and_news_1: {
    ga: 'Stay tuned for our latest research findings, tool releases, and events. Be a part of the FIoS community!',
