...
export class MessageService {
  ...
  */
  markAsOpened(id: any): Observable<any> {
  ...
  */
  getMessageAudio(id: any) : Observable<any> {
  ...
  */
  addMessageAudio(id: any, audioBlob: Blob) : Observable<any> {
  ...
  */  
  deleteAllMessages(userId: any): Observable<any> {
