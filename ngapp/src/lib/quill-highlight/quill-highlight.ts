...
export const QUILL_HIGHLIGHT_ATTRIBUTES = ["highlight-tag", "id", "right-edge", "left-edge", "synth-highlight", "synth-highlight-em"];
...
export class QuillHighlighter {
  ...
  private mouseOverTagElem(tags: HighlightTag[], span: { fromX: number, toX: number }) {
    ...
    style = style + `
        ...
        this.engagement.addMouseOverGrammarErrorEvent(tags);
      }
